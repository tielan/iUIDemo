...
-(void)createPointView{
    ...
    for (int page=0; page<_numberOfPages; page++) {
        if(page==_currentPage){
             UIView *currPointView=[[UIView alloc]initWithFrame:CGRectMake(startX, startY, _controlSize*2, _controlSize/2)];
            ...
            UIView *otherPointView=[[UIView alloc]initWithFrame:CGRectMake(startX, startY, _controlSize, _controlSize/2)];
