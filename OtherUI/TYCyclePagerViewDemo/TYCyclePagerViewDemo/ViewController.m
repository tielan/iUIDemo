...
@property (nonatomic, strong) TYPageControl *aapageControl;
...
- (void)viewWillLayoutSubviews {
    ...
    _pageControl.frame = CGRectMake(0, CGRectGetMaxY(_pagerView.frame)+10, [UIScreen mainScreen].bounds.size.width, 30);
}
...
- (void)pagerView:(TYCyclePagerView *)pageView didScrollFromIndex:(NSInteger)fromIndex toIndex:(NSInteger)toIndex {
     _pageControl.currentPage = pageView.curIndex;
